...
// ── Mise en page du bon de livraison ──
...
const FOOTER_H = 90;
const LOGO_RATIO = 182 / 113; // logo recadré (sans la marge blanche du fichier d'origine)
...
async function buildPdfBase64(numeroBL: number, dateStr: string, cmd: any, items: any[]) {
  ...
  // Total encadré, aligné à droite comme sur une facture
  y -= 16;
